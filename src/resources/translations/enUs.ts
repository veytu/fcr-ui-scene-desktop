export const enUs = {
  ...
  fcr_device_option_voice: 'Voice',
  fcr_device_option_video: 'Video',
  ...
  fcr_room_tips_end_poll: 'Teacher has ended the poll',
  fcr_room_tips_stop_sharing: 'You have stopped sharing',
  ...
  fcr_record_start_confirm_ok: 'Record',
  fcr_record_stop_confirm_ok: 'Stop',
  fcr_record_confirm_cancel: 'Cancel',
  fcr_room_button_recording: 'Recording',
  ...
  fcr_group_tips_group_added: 'New group is added',
  ...
  fcr_group_tips_leaving: 'Leaving group, please wait...',
  fcr_group_label_default_name: 'Group',
  ...
  fcr_group_create_group_yes: 'Yes',
  fcr_group_teacher_not_in_classroom: 'Teacher is not in this classroom',
  fcr_group_button_cancel: 'Cancel',
  fcr_group_stop_discussion: 'Stop discussion',
  fcr_group_button_stop: 'Stop',
  fcr_group_ungrouped: 'Ungrouped',
  ...
  fcr_group_button_assign: 'Assign',
  fcr_group_search: 'Search',
  fcr_group_no_data: 'No data',
  fcr_group_breakout_room: 'Breakout room',
  fcr_group_in_progress: 'In Progress',
  fcr_group_not_status: 'Not Started',
  fcr_group_minimization: 'Minimization',
  fcr_group_close: 'Close',
  ...
  fcr_cloud_upload_at: 'Updated at',
  fcr_cloud_size: 'Size',
  fcr_cloud_button_tooltip_rename: 'Rename',
  fcr_cloud_button_tooltip_delete: 'Delete the file',
  fcr_cloud_button_label_converting: 'Converting',
  fcr_cloud_button_delete: 'Delete',
  fcr_cloud_tips_delete_confirm_title: 'Delete',
  fcr_cloud_tips_delete_confirm_content: 'Are you sure to delete this file?',
  fcr_cloud_tips_delete_confirm_ok_text: 'Delete',
  ...
  fcr_board_ungranted: 'Your access to the whiteboard has been revoked by the teacher.',
  ...
  fcr_record_button_start_confirm_ok: 'Record',
  fcr_record_button_confirm_cancel: 'Cancel',
