...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: (theme) => ({
      // progress
      "gradient-1": `linear-gradient(90deg, ${theme(
        "colors.custom-1"
      )} 0%, ${theme("colors.custom-2")} 100%)`,
      "gradient-2": `linear-gradient(90deg, ${theme(
        "colors.custom-3"
      )} 2.67%, ${theme("colors.custom-4")} 100%)`,
      // devider
      "gradient-3": `linear-gradient(90deg, ${theme("notsb")} 0%, ${theme(
        "notsb-inverse"
      )} 100%)`,
    }),
